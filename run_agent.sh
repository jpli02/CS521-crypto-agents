...
# Main results 4o
python -u run_agent.py --model gpt-4o --starting_date 2023-04-12 --ending_date 2023-04-16 &>logs/crypto-bear-4o-mini.out 2>&1
# python -u run_agent.py --model gpt-4o --starting_date 2023-06-17 --ending_date 2023-08-25 &>logs/crypto-sideways-4o.out 2>&1
# python -u run_agent.py --model gpt-4o --starting_date 2023-10-01 --ending_date 2023-12-01 &>logs/crypto-bull-4o.out 2>&1
...
# # Main results 3.5
# python -u run_agent.py --starting_date 2023-04-12 --ending_date 2023-06-16 &>logs/crypto-bear.out 2>&1
# python -u run_agent.py --starting_date 2023-06-17 --ending_date 2023-08-25 &>logs/crypto-sideways.out 2>&1
# python -u run_agent.py --starting_date 2023-10-01 --ending_date 2023-12-01 &>logs/crypto-bull.out 2>&1
